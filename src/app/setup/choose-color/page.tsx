...
const ChooseColorPage = () => {
    ...
    reader.onloadend = async () => {
      ...
      try {
        ...
        if (data.url) {
          ...
          setPageData("ChooseColorPage", { logoUrl: data?.url });
  ...
  const handleGenerateLogo = async() => {
    const data = {
      brand_name:pageData.BrandNamePage.name,
    ...
    setPageData("ChooseColorPage", { logoUrl: response.data?.s3_url,fontColor: fontColor })
